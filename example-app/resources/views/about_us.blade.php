...
<h1 class="mt-10  flex ml-6 items-center text-5xl font-extrabold dark:text-white">Contact
    <span class="mt-1 ml-5 bg-blue-100 text-blue-800 text-2xl font-semibold me-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-2">US</span>
</h1>
...
<div class="mt-10 max-w-2xl mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg">
    ...
    <form method="POST" action="{{ route('messages.store') }}" >
        ...
        <div class="mb-6">
            <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your message</label>
