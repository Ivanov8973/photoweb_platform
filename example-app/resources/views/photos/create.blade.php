<x-layout>
    ...
    <div class="max-w-2xl mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg">
        ...
        <form method="POST" action="{{ route('photos.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-6">
                <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Photo
                    name</label>

                <input type="text" id="default-input" placeholder="Your description here..."
                    class="@error('name')
            border-red-500
            ...
            <div class="mb-6">
                ...
                <textarea type="text" id="default-input"
            ...
            <div class="mb-6">
                <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload
                    image</label>
